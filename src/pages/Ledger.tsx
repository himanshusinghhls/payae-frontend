                    ...
                    <AnimatePresence>
                      {isBaseExpanded && (
                        <motion.div initial={{ height: 0 }} animate={{ height: 'auto' }} exit={{ height: 0 }} className="bg-black/20 border-t border-white/5 overflow-hidden">
                          <div className="p-3 pl-14 flex justify-between items-center border-b border-white/5">
                            <span className="text-gray-400 font-medium text-xs">Sent to Receiver</span>
                            <span className="text-white font-bold text-sm">-₹{payment.amount.toFixed(2)}</span>
                          </div>
                          ...
                          <div className="p-3 pl-14 flex justify-between items-center cursor-pointer hover:bg-white/5 transition-colors group" onClick={() => setExpandedWalletId(isWalletExpanded ? null : payment.id)}>
                            <div className="flex items-center gap-2">
                              <Wallet className="w-3.5 h-3.5 text-payae-accent" />
                              <span className="text-payae-accent font-bold text-xs">PayAE Auto-Invest</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <span className="text-payae-success font-black text-sm">+₹{payment.totalRoundupAmount.toFixed(2)}</span>
