...
const fetchPortfolio = async (): Promise<PortfolioData> => {
  ...
  return { savingsBalance: Number(data.savingsBalance || data.savings || 0), mutualFundUnits: Number(data.mutualFundUnits || data.mf || 0), goldGrams: Number(data.goldGrams || data.gold || 0)};
};
